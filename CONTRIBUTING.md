...
1. `clone` your forked repository (_noob tip: the actual command you type in is everything after the $_):
   ...
   ```shell
   $ git clone https://github.com/<YOUR-USERNAME>/callable
   ```

1. Add a new remote that points to the original project so you can sync project changes with your local copy:

   ```shell
   $ git remote add upstream https://github.com/lopatnov/callable
   ```

1. Pull upstream changes into your local `master` branch:
...
[issues]: https://github.com/lopatnov/callable/issues
[pull-requests]: https://github.com/lopatnov/callable/pulls
[about]: https://lopatnov.github.io/callable/
[wiki]: https://github.com/lopatnov/callable/wiki
